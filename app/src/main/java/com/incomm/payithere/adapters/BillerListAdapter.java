...
public class BillerListAdapter extends RecyclerView.Adapter<BillerListAdapter.ViewHolder> implements Filterable{
    ...
    public BillerListAdapter(SelectBillerMVP.View view,List<BillerGroup> billerList, int globalTextColor,String rightChevron){
        this.view = view;
    ...
    @Override
    public BillerListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(BillerListAdapter.ViewHolder holder, int position) {
